...
import exabgp.bgp.message.update.attribute.tunnel_encap.sr_policy  # noqa: F401 — triggers tunnel type 15 registration
...
class TunnelEncap(Attribute):
    ...
    @staticmethod
    def unpack(data: Buffer, direction: Any, negotiated: Any) -> 'TunnelEncap':
        ...
        return TunnelEncap(tunnel_tlvs=tunnel_tlvs)
